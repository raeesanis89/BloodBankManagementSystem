...
$bloodgroup = mysqli_real_escape_string($conn,$_POST['bloodgroup']);
 ...
 //$balance = $fees-$advancefees;
  ...
  $q1 = $conn->query("INSERT INTO student (sname,contact,about,emailid,branch,bloodgroup,joindate,balance,fees) VALUES ('$sname','$contact','$about','$emailid','$branch','$bloodgroup', '$joindate', '$balance', '$fees')") ;
 ...
 $id = mysqli_real_escape_string($conn,$_POST['id']);	
   $sql = $conn->query("UPDATE  student  SET  branch  = '$branch', bloodgroup  = '$bloodgroup' WHERE  id  = '$id'");
...
{
$errormsg = "<div class='alert alert-success'> <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>Success!</strong> Patient Add successfully</div>";
}else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="2")
{
$errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> <strong>Success!</strong> Patient Edit successfully</div>";
}
else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="3")
{
$errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>Success!</strong> Patient Delete successfully</div>";
}
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Patients  
						<?php
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-primary">
                        <div class="panel-heading">
                           <?php echo ($action=="add")? "Add Patient": "Edit Patient"; ?>
                        </div>
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Hospital* </label>
								<div class="col-sm-10">
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Blood Group* </label>
								<div class="col-sm-10">
						...
						?>
						 ...
						 <legend  class="scheduler-border">Optional Information:</legend>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Password">About Patient </label>
								<div class="col-sm-10">
                        ...
                        <div class="panel-body">
                            <div class="table-sorting table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
                                    ...
                                    <tbody>
									<?php
									$sql = "SELECT s.*, b.branch FROM `student` s LEFT OUTER JOIN branch b on b.id = s.branch where s.delete_status='0'";
									$q = $conn->query($sql);
									$i=1;
									while($r = $q->fetch_assoc())
									{
